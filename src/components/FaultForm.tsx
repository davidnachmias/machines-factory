...
const FaultForm: React.FC<FaultFormProps> = ({
  machineName,
  machineId,
  onAddFaultForm,
  showPopup,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const selectedMachineData = machines.find(
      (machine) => machine._id === selectedMachine
    );
      ...
      <div
        className={
          showPopup
            ...
            : "w-full max-w-md p-8 bg-white shadow-lg rounded-lg"
        }
      >
        <h1 className="text-xl font-bold mb-6 sm:mb-10 text-center">
          הוספת תקלה/טיפול תקופתי
        </h1>
